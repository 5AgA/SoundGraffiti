...
function Home({ feed = [], onCommentSheetOpenChange, onCommentCreated }) {
  ...
  const [sheetInteractiveHeightPx, setSheetInteractiveHeightPx] = useState(null);
  ...
  const sheetPostFresh = useMemo(() => {
    ...
    const hit = feed.find((p) => p != null && String(p.post_id) === pid);
    return hit ?? commentSheetPost;
  }, [feed, commentSheetPost]);
        ...
        setPendingSheetComments((prev) => [
          ...prev,
          {
            ...
            Users: {
              ...
              user_profile_url: composerAvatar || null,
            },
          },
        ]);
      }
                  ...
                  {sheetCommentsThread.map(({ row, depth }) => {
                    ...
                    return (
                      <li
                        ...
                        onTouchStart={
                          ownRow
                            ? handleCommentRowTouchStart(row)
                            : undefined
                        }
                        onTouchMove={
                        ...
                        onContextMenu={
                          ownRow
                            ? handleOwnCommentContextMenu(row)
                            : undefined
                        }
                      >
                        {avatar ? (
